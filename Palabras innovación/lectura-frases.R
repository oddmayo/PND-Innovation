...
setwd("C:/Users/cmayorquin/Desktop/PND/PNDTT/Palabras innovación")
remove(list=ls())
require(pdftools)
# La magia
require(tesseract)
...
ind.pages <- list(
  "2018"=list("1"=matrix(c( 35,  40), 1, 2, byrow=TRUE),
              "2"=matrix(c( 45,  138), 1, 2, byrow=TRUE),
              "3"=matrix(c( 145, 196,
                            198, 217), 2, 2, byrow=TRUE),
              "4"=matrix(c( 225, 419), 1, 2, byrow=TRUE),
              "5"=matrix(c(432, 487), 1, 2, byrow=TRUE),
              "6"=matrix(c(494, 540), 1, 2, byrow=TRUE),
              "7"=matrix(c(546, 592), 1, 2, byrow=TRUE),
              "8"=matrix(c(597, 629), 1, 2, byrow=TRUE),
              "9"=matrix(c(635, 662), 1, 2, byrow=TRUE),
              "10"=matrix(c(669, 694), 1, 2, byrow=TRUE),
              "11"=matrix(c(701, 732), 1, 2, byrow=TRUE),
              "12"=matrix(c(737, 789), 1, 2, byrow=TRUE),
              "13"=matrix(c(795, 851), 1, 2, byrow=TRUE),
              "14"=matrix(c(857, 872), 1, 2, byrow=TRUE),
              "15"=matrix(c(877, 904,
                            906, 921), 2, 2, byrow=TRUE),
              "16"=matrix(c(927, 945), 1, 2, byrow=TRUE),
              "17"=matrix(c(949, 950,
                            952, 1001,
                            1003, 1014), 3, 2, byrow=TRUE),
              "18"=matrix(c(1029, 1037), 1, 2, byrow=TRUE),
              "19"=matrix(c(1039, 1045), 1, 2, byrow=TRUE),
              "20"=matrix(c(1047, 1052), 1, 2, byrow=TRUE),
              "21"=matrix(c(1053, 1058), 1, 2, byrow=TRUE),
              "22"=matrix(c(1059, 1065), 1, 2, byrow=TRUE),
              "23"=matrix(c(1067, 1072), 1, 2, byrow=TRUE),
              "24"=matrix(c(1073, 1079), 1, 2, byrow=TRUE),
              "25"=matrix(c(1081, 1087), 1, 2, byrow=TRUE),
              "26"=matrix(c(1089, 1093), 1, 2, byrow=TRUE),
              "27"=matrix(c(1099, 1141), 1, 2, byrow=TRUE),
              "28"=matrix(c(1145, 1175,
                            1177, 1189), 2, 2, byrow=TRUE),
              "29"=matrix(c(1192, 1284,
                            1289, 1322), 2, 2, byrow=TRUE)
  ))
...
for(ian in 1:numAns){#:numAns
  ...
  for(icap in 1:cont.caps.an ){#:cont.caps.an
    ...
    save(text.capt, file = paste("C:/Users/cmayorquin/Desktop/PND/PNDTT/Palabras innovación/docs/PlainPages/",an,"/Cap",
                                 sprintf("%02d",icap),".RData",sep=""))
    
    cat(text.capt,
        file = paste("C:/Users/cmayorquin/Desktop/PND/PNDTT/Palabras innovación/docs/PlainTxts/",an,"/Cap",
    ...
    save(text.capt, file = paste("C:/Users/cmayorquin/Desktop/PND/PNDTT/Palabras innovación/docs/CleanPages/",an,"/Cap",
                                 sprintf("%02d",icap),".RData",sep=""))
    
    cat(text.capt,
        file = paste("C:/Users/cmayorquin/Desktop/PND/PNDTT/Palabras innovación/docs/CleanTxts/",an,"/Cap",
                     sprintf("%02d",icap),".txt",sep=""),
        sep = "\n")
